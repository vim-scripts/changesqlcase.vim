...
"
" Customization:
" 1. add the letter c as the very last character of the last line of function
...
" \U\2\E/gie
"
" uppercases the second atom with g i and e flags.  Some people might want to
" add the c flag to confirm all changes
"
:'<,'>s/\(\_^\|\W\)\@<=\(
	\abort\|
	\abs\|
